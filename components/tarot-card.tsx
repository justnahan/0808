    ...
    <div className={`tarot-card-container ${className}`}>
      ...
      >
        ...
        <div className="card-face card-front">
          <Card className="w-full h-full bg-card/90 border-border backdrop-blur-sm group/card relative">
            {/* 詳細資訊按鈕 */}
              ...
              {card && (
                <>
                  <div className="text-center mb-3 md:mb-4">
                    <div className={`w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-3 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center ${isReversed ? 'rotate-180' : ''}`}>
                  ...
                  <div className="flex-1 space-y-2 md:space-y-3 min-h-0">
                    <div className="flex-1">
                      ...
                      <div className="text-xs md:text-sm text-muted-foreground leading-relaxed overflow-hidden">
                        ...
                        {showDetailButton && isRevealed && (
                          <p className="text-xs text-primary/70 mt-1">點擊右上角查看完整解讀</p>
                        )}
                      </div>
                    </div>
